...
import { paramsValidation, signInSchemaValidation, signUpSchemaValidation } from "./user.validation.js";
...
router.get("/shareprofile/:id"  ,validation(paramsValidation), auth , shareProfile )
