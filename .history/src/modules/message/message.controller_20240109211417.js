...
export const getAllMessages = async (req, res) => {
    try {
        ...
        // const messages = await messageModel.find().sort({createdAt:-1}).populate([
        //     {
        //         path:"sendTo",
        ...
        const messages = await messageModel.aggregate([
            {
                $lookup: {
                    ...
                    localField: 'ownerId', // The field from the input documents
                    foreignField: '_id',   // The field from the "owners" collection
                    as: 'owner',           // The alias for the resulting array of joined documents
                  },
